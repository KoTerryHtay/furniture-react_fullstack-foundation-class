...
export default function MobileNavigation({ items }: MainNavigationProp) {
    ...
    <div className="lg:hidden">
      <Sheet>
        ...
        <SheetContent side={"left"} className="pt-9 pl-4">
          ...
          <ScrollArea className="my-4 mr-4 h-[calc(100vh-8rem)] pb-8">
            <Accordion type="multiple">
              <AccordionItem value={items![0].title} className="w-full">
